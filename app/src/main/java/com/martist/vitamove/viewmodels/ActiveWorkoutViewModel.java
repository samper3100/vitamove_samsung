    ...
    public void addExercise(String exerciseId, String userId) {
        ...
        executor.execute(() -> {
            ...
            try {
                ...
                String exerciseType = fullExercise.getExerciseType() != null ? fullExercise.getExerciseType().toLowerCase() : "";
                boolean isCardio = exerciseType.contains("кардио") || exerciseType.contains("cardio") || exerciseType.contains("статич") || exerciseType.contains("static") || exerciseType.contains("удержание") || exerciseType.contains("планка");
