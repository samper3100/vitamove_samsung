...
public class SupabaseWorkoutRepository implements WorkoutRepository {
    ...
    public String createWorkoutFromPlan(WorkoutPlan plan) throws Exception {
        ...
        try {
            ...
            if (!success || newWorkoutId == null || newWorkoutId.isEmpty() || newWorkoutId.equals("null")) {
                 ...
                 Log.e(TAG, "Ошибка выполнения SQL-функции create_workout_from_plan_func: " + errorMessage + " (Результат RPC: " + rpcResult.toString() + ")"); 
    ...
    @Override
    public List<UserWorkout> getWorkoutHistory(String userId, long startDate, long endDate) throws Exception {


        return getWorkoutHistory(userId, startDate, endDate, 0, 1000);
    }
            ...
            if (workouts != null) {
                ...
                try {
                    ...
                    for (Exercise exercise : exercisesById.values()) {
                        ...
                        exerciseEntity.setDifficulty(exercise.getDifficulty().toString());
